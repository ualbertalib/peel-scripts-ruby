...
#local end
# ary = Array.new
#  Dir.glob("/media/baihong/UofA Drive 0805/UAL/Shipment_041/UAL-PEE-0043/**/*METS.xml") do |f|
...
#  File.open('object_to_check.marshal', "w"){|to_file| Marshal.dump(ary, to_file)}
  ...
  Dir.glob("/media/baihong/RUGGED-4/Shipment_053_2/AlbertaNewspapers/Shipment_66/**/*METS.xml") do |f|
    objectpath=File.basename(f)
    #puts objectpath
    object=objectpath.split("_")[0]
    puts object
  end
